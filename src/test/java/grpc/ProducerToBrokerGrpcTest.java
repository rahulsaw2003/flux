...
//        Admin admin = MiniKafkaAdminClient.create(Set.of(new InetSocketAddress("localhost", 50051))); // bootstrap server
...
//        admin.createTopics(List.of(topic));
    ...
    private static void startClient() {
        MiniKafkaProducer<String, String> producer = new MiniKafkaProducer<>(new Properties(), 15, 60);
        while (true) {
