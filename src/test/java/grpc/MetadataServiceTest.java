...
public class MetadataServiceTest {
    ...
    public void testOnlyMetadataCacheAutoRefreshing() {
        ...
        // Change the interval inside MiniKafkaProducer--by default its 5 mins (change to 1 min for quicker testing).
        MiniKafkaProducer<String, String> producer = new MiniKafkaProducer<>(new Properties(), 300, 300);
        while (true) {}
    }
