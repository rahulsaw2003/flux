 ...
 *
 * This test validates that multiple MiniKafkaProducers can connect to a single broker
...
public class MiniKafkaParallelProducerTest {
    ...
    void testParallelProducersSendingToBroker() throws Exception {
        ...
        List<MiniKafkaProducer<String, String>> producers = new ArrayList<>();

        // Create producers
        for (int i = 0; i < numProducers; i++) {
            MiniKafkaProducer<String, String> producer = new MiniKafkaProducer<>(new Properties(), 1, 2);
        ...
        for (int i = 0; i < numProducers; i++) {
            ...
            final MiniKafkaProducer<String, String> producer = producers.get(i);
        ...
        // Close all producers
        for (MiniKafkaProducer<String, String> producer : producers) {
            producer.close();
        }
    }
