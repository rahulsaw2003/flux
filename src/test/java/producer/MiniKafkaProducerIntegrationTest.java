...
public class MiniKafkaProducerIntegrationTest {
    ...
    @Test
    public void testMiniKafkaProducerWithAccumulator() throws IOException {
        // This test validates that MiniKafkaProducer can be created with RecordAccumulator
        // and send records without compilation errors

        MiniKafkaProducer<String, String> producer = new MiniKafkaProducer<>(props, 0, 100);
