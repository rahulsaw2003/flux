...
/**
 * MiniKafkaAdmin is a Singleton class to represent a single Admin client.
 * The admin client is responsible for creating topics, managing partitions per topic,
 * and much more.
 *
 * Note: The MiniKafkaAdminClient can also programmatically start up a cluster of Brokers upon initialization, unlike Kafka.
 */
public class MiniKafkaAdminClient implements Admin {
    private static MiniKafkaAdminClient instance = null;
    ...
    private MiniKafkaAdminClient(Properties props) {
    ...
    public static Admin create(Properties props) {
        if (instance == null) {
            ...
            instance = new MiniKafkaAdminClient(props);
        } else {
    ...
    // commons.MiniKafkaTopic -> the *actual* topic within our system. contains partitions and other info
    @Override
